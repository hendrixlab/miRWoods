...
my $positiveTrainData = $parameters->{posTrainFile};
my $negativeTrainData = $parameters->{negTrainFile};
my $label = $parameters->{aucLabel};
miRWoods::generateSVMAucFileUsingR($positiveTrainFile,$negativeTrainFile,$label);
