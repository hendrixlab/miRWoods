...
my $USAGE = "USAGE:\n$0 -S <SizesFile> -b <BamListFile> -g <genome directory> -G <mirBase GFF> -o <outputPrefix>
...
GetOptions ("GFF=s" => \$parameters->{GFF},
...
miRWoods::mirPreprocess($bamList,$hairpins,$genomeDir,$chromLengths,$parameters);
